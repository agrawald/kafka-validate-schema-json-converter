...
/**
 * JSON deserializer for Jackson's JsonNode tree model. Using the tree model allows it to work with
 * arbitrarily structured data without having associated Java classes. This deserializer also
...
public class JsonDeserializer implements Deserializer<JsonNode> {
  ...
  /**
   * A constructor that additionally specifies some {@link DeserializationFeature} for the
   * deserializer
   *
