...
/** Configuration options for {@link ValidateSchemaJsonConverter} instances. */
public class ValidateSchemaJsonConverterConfig extends ConverterConfig {
  ...
  static {
    ...
    CONFIG.define(
        ...
        ConfigDef.ValidString.in(DecimalFormat.BASE64.name(), DecimalFormat.NUMERIC.name()),
        Importance.LOW,
        DECIMAL_FORMAT_DOC,
        group,
        orderInGroup++,
  ...
  public ValidateSchemaJsonConverterConfig(Map<String, ?> props) {
    super(CONFIG, props);
