...
/**
 * Serialize Jackson JsonNode tree model objects to UTF-8 JSON. Using the tree model allows handling
 * arbitrarily structured data without corresponding Java classes. This serializer also supports
 * Connect schemas.
 */
public class JsonSerializer implements Serializer<JsonNode> {
  ...
  /**
   * A constructor that additionally specifies some {@link SerializationFeature} for the serializer
   *
